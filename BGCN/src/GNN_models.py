...
class GnnModel:
    def __init__(self, FLAGs, node_features, one_hot_labels, adj, y_train, y_val, y_test, train_mask, val_mask, test_mask, acc_sample_graph,
                 checkpt_name, 
                 model_name='BGCN'):
        ...
        self.acc_sample_graph = acc_sample_graph
